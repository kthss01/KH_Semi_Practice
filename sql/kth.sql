...
-- project 페이지별로 가져오기
SELECT * FROM (SELECT ROWNUM RNUM, A.* FROM (SELECT * FROM PROJECT ORDER BY PROJECT_CODE) A) WHERE RNUM BETWEEN 560 AND 580;
-- selectProjectList
--SELECT ROWNUM, A.* FROM (SELECT * FROM PROJECT ORDER BY PROJECT_CODE) A WHERE ROWNUM BETWEEN ? AND ?
